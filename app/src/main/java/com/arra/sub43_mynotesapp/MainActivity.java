...
import com.arra.sub43_mynotesapp.adapter.NoteAdapter;
import com.arra.sub43_mynotesapp.db.NoteHelper;
import com.arra.sub43_mynotesapp.entity.Note;

import java.lang.ref.WeakReference;
import java.util.ArrayList;

import static com.arra.sub43_mynotesapp.NoteAddUpdateActivity.REQUEST_UPDATE;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            progressBar.setVisibility(View.INVISIBLE); // additional
